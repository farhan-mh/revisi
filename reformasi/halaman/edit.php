...
<?php
 include '../konek.php';
 $id = $_GET['id'];
$ambilData = mysqli_query($koneksi,"SELECT * FROM tesinput WHERE id ='$id' ");
   while ($tampil = mysqli_fetch_array($ambilData)){
  ?>
  <h1 align="center">Edit Kolom</h1>
  <hr>
<p> <form action="update.php" method="post" enctype="multipart/form-data">
  ...
  <?php // $file_name = $_FILES['NamaFile']['name'];  ?>
   ...
   <br><br><br>
   <a href="../m.php" class="btn btn-warning">kembali</a>
